...
function seed() {
  ...
  // Insert Students for Profe (username: profe)
  insertStudent.run(101, 3, 1, 'FLORENCIA', 'VALENZUELA', '52114477', '27-52114477-8', '2014-06-15', 'LIBRE C - 3ERA C', 'OSDE 310', 'POL-88221', 'APTO MÉDICO OK', 'LILIANA VALENZUELA', '+54 9 264 411 2233');
  insertStudent.run(102, 3, 1, 'MARTINA', 'BENÍTEZ', '54332211', '27-54332211-3', '2016-09-22', 'LIBRE C - INICIACIÓN A', 'SWISS MEDICAL', 'POL-33441', 'SIN OBSERVACIONES', 'GUSTAVO BENÍTEZ', '+54 9 264 522 3344');
  insertStudent.run(103, 3, 1, 'ISABELLA', 'PEREYRA', '56998811', '27-56998811-5', '2018-03-10', 'SOLO DANCE - MINI TOTS', 'SANCOR SALUD', 'POL-77112', 'ALERGIA POLVO', 'ROSA PEREYRA', '+54 9 264 633 4455');
  insertStudent.run(104, 3, 1, 'CAMILA EMILIA', 'PAREDES', '49887766', '27-49887766-1', '2012-11-05', 'LIBRE B - PROMO B', 'MEDIFE', 'POL-55667', 'APTO MÉDICO OK', 'MARCELO PAREDES', '+54 9 264 744 5566');
